...
void main() {
  runApp(MyApp(listOfBook: listOfBook));
}

class MyApp extends StatelessWidget {
  final List<Book> listOfBook;

  MyApp({required this.listOfBook});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: MyLibrary(listOfBook: listOfBook),
    );
  }
}
...
class MyLibrary extends StatelessWidget {
  ...
  MyLibrary({required this.listOfBook});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BookList(listOfBook: listOfBook),
    );
  }
}
...
class BookList extends StatelessWidget {
  ...
  BookList({required this.listOfBook});
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return GestureDetector(
          onTap: () {
            _showDetailsOfBook(context, listOfBook[index]);
          },
          child: Card(
            elevation: 2.0,
            child: Row(
  ...
  void _showDetailsOfBook(BuildContext context, Book book) {
